...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস zisan খানকিরপুলারে একটা মেনশন দেন-!!😈", event.threadID);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি zisan তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "তোর বোন এর কচি ভুদা ফাডামু। ভুস্কি মাগির পোলা 🤣" + " zisan boss তোর আব্বু " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a("~ zisan BOSS এর জারজ পুত যা ভাগ🤖")} , 39000);
 }
